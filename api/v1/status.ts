...
export default async function handler(req: Request): Promise<Response> {
  ...
  return jsonResponse({
    ...
    disclaimer: "Informational only. For official emergency alerts, see weather.gov and your county's emergency alert system. Full Terms of Use & Disclaimer: https://redflag-check.info/terms",
